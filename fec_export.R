# ===========================================================================================
# Load Libraries & Prepare the Workstation
# ===========================================================================================

# set the working directory
setwd("~/") # DO NOT FORGET TO SET THE WORKING DIRECTORY
...
# ensure that the sheet is saved in that folder. More information available on the readme file
...
# The code below automates the process of pulling multiple sheets at a time by downloading 
